...
const apiKey = "WBUoCfaNeQDusmLJKNW3OAshmdefAfgzvBLf65cd";  
...
const search =  `clothing AND topic:"Women" AND online_media_type:"Images"`;
...
let currentDate = "";
  if(objectData.content.freetext.date) {
    currentDate = objectData.content.freetext.date[0].content;
  }
